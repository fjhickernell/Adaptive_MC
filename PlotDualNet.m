...
for m=r+1:mmax
    ...
    for i=1:length(kxdiff)
        plot(kxdiff(i),kydiff(i),'b.','markersize',50*kdiffsize(i).^(1/6))
    end
    for i=1:length(kxfull)
        plot(kxfull(i),kyfull(i),'r.','markersize',50*kfullsize(i).^(1/6))
    end
    set(gca,'xtick',[0.5 1 10 100 1000],'ytick',[0.5 1 10 100 1000],...
        'xticklabel',[0 1 10 100 1000],'yticklabel',[0 1 10 100 1000])
    axis([0.5 kmax 0.5 kmax])
